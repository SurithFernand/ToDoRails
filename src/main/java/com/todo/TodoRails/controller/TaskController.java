...
import com.todo.TodoRails.service.TaskService;
...
public class TaskController {
    ...
    public String dashboard(Model model) {
        ...
        // Add today's tasks to the model
        ...
        // Add to model to send the formatted date to the view
        model.addAttribute("serverTime", formattedDate);

        // Count and add the completed and pending tasks to the model
