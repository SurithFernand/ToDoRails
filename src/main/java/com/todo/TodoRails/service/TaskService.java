package com.todo.TodoRails.service;

import com.todo.TodoRails.model.Task;
import com.todo.TodoRails.model.User;
import com.todo.TodoRails.repository.TaskRepository;
import com.todo.TodoRails.repository.UserRepository;
...
public class TaskService {
    ...
    public List<Task> getTodayTasksForCurrentUser() {
        ...
        // Get today's incomplete tasks for the current user
    ...
    public int countByCompleted(boolean completedStatus) {
        ...
        // Return count of tasks based on completion status
